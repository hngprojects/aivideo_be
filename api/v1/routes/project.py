...
@project_router.get("/{project_id}", response_model=success_response, status_code=204)
...
@project_router.post("/{id}/save", response_model=success_response, status_code=200)
