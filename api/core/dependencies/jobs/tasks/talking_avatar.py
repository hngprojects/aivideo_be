...
def process_talking_avatar(
    ...
    logging.info('Generating audio fro script')
    ...
    logging.info('Making API request to generate talking head video')
    ...
    logging.info('Downloading and saving talking head video')
    ...
    if audio_file:
        logging.info('Adding background audio to file')
