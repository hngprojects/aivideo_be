...
REQUEST_PASSWORD_REQUEST_ENDPOINT = '/api/v1/auth/request-forget-password'
GET_PASSWORD_RESET_ENDPOINT = '/api/v1/auth/forget-password'
POST_PASSWORD_RESET_ENDPOINT = 'api/v1/auth/forget-password'
